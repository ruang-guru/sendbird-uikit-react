...
describe('MessageInput', () => {
  it('should render upload icon if no text is present', () => {
    const component = shallow(<MessageInput onSendMessage={noop} value="" />);
    // TODO: complete the test case
    // expect(
    //   component.find('.sendbird-message-input--send').exists()
    // ).toBe(false);
    expect(component.find('.sendbird-message-input--attach').exists()).toBe(
      true
    );
    expect(
  ...
  it('should render send icon if text is present', () => {
    ...
    expect(component.find('.sendbird-message-input--send').exists()).toBe(true);
    // TODO: complete the test case
    // expect(
  ...
  it('should display save/cancel button on edit mode', () => {
    ...
    expect(component.find('.sendbird-message-input--send').exists()).toBe(
      false
    );
    expect(component.find('.sendbird-message-input--attach').exists()).toBe(
      false
