...
var reducer = function reducer(accumulator, currentValue) {
  if (Array.isArray(currentValue)) {
    return __spreadArray(__spreadArray([], accumulator), currentValue);
  } else {
...
var getChannelsWithUpsertedChannel = function getChannelsWithUpsertedChannel(channels, channel) {
  ...
  return __spreadArray(__spreadArray(__spreadArray([], channels.slice(0, targetIndex)), [channel]), channels.slice(targetIndex, channels.length));
};
...
//# sourceMappingURL=index-fdb4da25.js.map
