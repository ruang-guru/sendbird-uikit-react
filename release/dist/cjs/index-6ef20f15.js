...
var index$1 = require('./index-669a9aef.js');
var index = require('./index-35867d77.js');
var index$2 = require('./index-80f75304.js');
var index$3 = require('./index-7c43dd21.js');
var index$4 = require('./index-0695f5eb.js');
var index$5 = require('./index-70f48e28.js');
    ...
    case ON_MESSAGE_RECEIVED:
      {
        ...
        return LocalizationContext._objectSpread2(LocalizationContext._objectSpread2({}, state), {}, {
          ...
          unreadSince: _unreadCount === 1 ? LocalizationContext.format(new Date(), 'HH.mm dd MMMM yyyy') : unreadSince,
          allMessages: passUnsuccessfullMessages(state.allMessages, message)
        });
      }
    ...
    case ON_MESSAGE_UPDATED:
      {
        ...
        if (!index$2.compareIds(_channel2.url, _currentGroupChannelUrl2)) {
    ...
    case ON_MESSAGE_THREAD_INFO_UPDATED:
      {
        ...
        if (!index$2.compareIds(_channel3.url, _currentGroupChannelUrl3) || !index$2.compareIds(_channel3.url, channelUrl)) {
          return state; // Ignore event when it is not for the current channel
        }

        return LocalizationContext._objectSpread2(LocalizationContext._objectSpread2({}, state), {}, {
          allMessages: state.allMessages.map(function (m) {
            if (index$2.compareIds(m.messageId, targetMessageId)) {
              // eslint-disable-next-line no-param-reassign
  ...
  React.useEffect(function () {
    ...
    if (channelUrl && sdk && sdk.ChannelHandler) {
      ...
      ChannelHandler.onMessageReceived = function (channel, message) {
        ...
        if (index$2.compareIds(channel.url, channelUrl) && !hasMoreToBottom) {
      ...
      ChannelHandler.onReadReceiptUpdated = function (channel) {
        if (index$2.compareIds(channel.url, channelUrl)) {
      ...
      ChannelHandler.onChannelChanged = function (groupChannel) {
        if (index$2.compareIds(groupChannel.url, channelUrl)) {
  ...
  return React.useMemo(function () {
    return function (_ref3) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(index$1.EmojiListItems, {
        ...
        }, /*#__PURE__*/React__default["default"].createElement(index$3.ImageRenderer, {
          url: emoji.url,
          width: "28px",
          height: "28px",
          defaultComponent: /*#__PURE__*/React__default["default"].createElement(index$3.Icon, {
            width: "28px",
            height: "28px",
            type: index$3.IconTypes.QUESTION
          })
        }));
      }));
    };
...
function MessageStatus(_ref) {
  ...
  var iconType = (_iconType = {}, LocalizationContext._defineProperty(_iconType, MessageStatusTypes.SENT, index$3.IconTypes.DONE), LocalizationContext._defineProperty(_iconType, MessageStatusTypes.DELIVERED, index$3.IconTypes.DONE_ALL), LocalizationContext._defineProperty(_iconType, MessageStatusTypes.READ, index$3.IconTypes.DONE_ALL), LocalizationContext._defineProperty(_iconType, MessageStatusTypes.FAILED, index$3.IconTypes.ERROR), _iconType);
  var iconColor = (_iconColor = {}, LocalizationContext._defineProperty(_iconColor, MessageStatusTypes.SENT, index$3.IconColors.SENT), LocalizationContext._defineProperty(_iconColor, MessageStatusTypes.DELIVERED, index$3.IconColors.SENT), LocalizationContext._defineProperty(_iconColor, MessageStatusTypes.READ, index$3.IconColors.READ), LocalizationContext._defineProperty(_iconColor, MessageStatusTypes.FAILED, index$3.IconColors.ERROR), _iconColor);
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, showMessageStatusIcon && (messageStatus === MessageStatusTypes.PENDING ? /*#__PURE__*/React__default["default"].createElement(index$3.Loader, {
    ...
    className: "sendbird-message-status__icon",
    type: iconType[messageStatus] || index$3.IconTypes.ERROR,
    fillColor: iconColor[messageStatus],
    width: "16px",
    height: "16px"
  })), index.isSentStatus(messageStatus) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-message-status__text",
    type: index$3.LabelTypography.CAPTION_3,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, LocalizationContext.format(message === null || message === void 0 ? void 0 : message.createdAt, 'p', {
    locale: dateLocale
  })));
}
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    menuTrigger: function menuTrigger(toggleDropdown) {
      return /*#__PURE__*/React__default["default"].createElement(index$1.IconButton, {
        ...
        type: index$3.IconTypes.EMOJI_MORE,
        fillColor: index$3.IconColors.CONTENT_INVERSE,
        width: "24px",
        height: "24px"
      }));
        ...
        return /*#__PURE__*/React__default["default"].createElement(ReactionButton, {
          ...
          placeHolder: function placeHolder(style) {
            return /*#__PURE__*/React__default["default"].createElement("div", {
              ...
              type: index$3.IconTypes.QUESTION,
              fillColor: index$3.IconColors.ON_BACKGROUND_3,
              width: "28px",
              height: "28px"
            }));
          }
...
function Tooltip(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    color: index$3.LabelColors.ONCONTENT_1
  }, children));
}
Tooltip.propTypes = {
...
var ReactionBadge = /*#__PURE__*/React__default["default"].forwardRef(function (props, ref) {
  ...
  }, children), /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
...
function TextMessageItemBody(_a) {
  ...
  var stringSet = React.useContext(LocalizationContext.LocalizationContext).stringSet;
  return /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    type: index$3.LabelTypography.BODY_1,
    color: isByMe ? index$3.LabelColors.ONCONTENT_1 : index$3.LabelColors.ONBACKGROUND_1
  ...
  }, message === null || message === void 0 ? void 0 : message.message, index.isEditedMessage(message) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-text-message-item-body__message edited",
    type: index$3.LabelTypography.BODY_1,
    color: isByMe ? index$3.LabelColors.ONCONTENT_2 : index$3.LabelColors.ONBACKGROUND_2
...
function FileMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: {
      WORD: index$3.IconTypes.ROGU_FILE_WORD,
      EXCEL: index$3.IconTypes.ROGU_FILE_EXCEL,
      PPT: index$3.IconTypes.ROGU_FILE_POWERPOINT,
      PDF: index$3.IconTypes.ROGU_FILE_PDF,
      OTHERS: index$3.IconTypes.ROGU_FILE_OTHERS
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    placeHolder: function placeHolder(style) {
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        type: index.isVideoMessage(message) ? index$3.IconTypes.PLAY : index$3.IconTypes.PHOTO,
    ...
    type: index.isVideoMessage(message) ? index$3.IconTypes.PLAY : index$3.IconTypes.GIF,
    fillColor: index$3.IconColors.GRAY,
    width: "34px",
    height: "34px"
  }))));
}
...
function OGMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }), index.isEditedMessage(message) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-og-message-item-body__text-bubble__message",
    type: index$3.LabelTypography.BODY_1,
    color: isByMe ? index$3.LabelColors.ONCONTENT_2 : index$3.LabelColors.ONBACKGROUND_2
    ...
    onClick: openOGUrl
  }, ((_g = message === null || message === void 0 ? void 0 : message.ogMetaData) === null || _g === void 0 ? void 0 : _g.title) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-og-message-item-body__description__title",
    type: index$3.LabelTypography.SUBTITLE_2,
    color: index$3.LabelColors.ONBACKGROUND_1
  }, message.ogMetaData.title), ((_h = message === null || message === void 0 ? void 0 : message.ogMetaData) === null || _h === void 0 ? void 0 : _h.description) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-og-message-item-body__description__description",
    type: index$3.LabelTypography.BODY_2,
    color: index$3.LabelColors.ONBACKGROUND_1
  }, message.ogMetaData.description), ((_j = message === null || message === void 0 ? void 0 : message.ogMetaData) === null || _j === void 0 ? void 0 : _j.url) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
...
function UnknownMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: index$3.LabelTypography.BODY_1,
    color: isByMe ? index$3.LabelColors.ONCONTENT_1 : index$3.LabelColors.ONBACKGROUND_1
  }, stringSet.UNKNOWN__UNKNOWN_MESSAGE_TYPE), /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
...
function QuoteMessage(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    defaultComponent: /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index.isVideo(parentMessageType) ? index$3.IconTypes.PLAY : index$3.IconTypes.PHOTO,
      fillColor: index$3.IconColors.ON_BACKGROUND_2,
      width: "22px",
      height: "22px"
    })))
    ...
    type: (_b = {}, _b[uikitFileTypes.IMAGE] = index$3.IconTypes.PHOTO, _b[uikitFileTypes.VIDEO] = index$3.IconTypes.PLAY, _b[uikitFileTypes.AUDIO] = index$3.IconTypes.FILE_AUDIO, _b[uikitFileTypes.GIF] = index$3.IconTypes.GIF, _b[uikitFileTypes.OTHERS] = index$3.IconTypes.FILE_DOCUMENT, _b)[index.getUIKitFileType(parentMessageType)],
    fillColor: index$3.IconColors.ON_BACKGROUND_3,
    width: "16px",
    height: "16px"
  }), /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
...
function MessageContent(_a) {
  ...
  React__default["default"].createElement(index$1.ContextMenu, {
  ...
  }, !isByMe && !chainTop && !useReplying && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    ...
    toggleReaction: toggleReaction
  })), !isByMe && !chainBottom && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: index.getClassName(['sendbird-message-content__middle__body-container__created-at', 'right', supposedHoverClassName]),
    type: index$3.LabelTypography.CAPTION_3,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, LocalizationContext.format(message.createdAt, 'p', {
    locale: dateLocale
  })))), /*#__PURE__*/React__default["default"].createElement("div", {
...
function MessageHoc(_ref) {
  ...
  if (RenderedMessage) {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$3.LabelTypography.CAPTION_2,
      color: index$3.LabelColors.ONBACKGROUND_2
    }, LocalizationContext.format(message === null || message === void 0 ? void 0 : message.createdAt, 'MMMM dd, yyyy', {
      locale: dateLocale
  ...
  LocalizationContext._createClass(ConversationScroll, [{
    ...
    value: function render() {
      ...
      if (allMessages.length < 1) {
        return /*#__PURE__*/React__default["default"].createElement(index$3.PlaceHolder, {
          className: "sendbird-conversation__no-messages",
          type: index$3.PlaceHolderTypes.NO_MESSAGES
        });
      }
...
function Notification(_ref) {
  ...
  return (
    ...
    React__default["default"].createElement("div", {
      ...
      color: index$3.LabelColors.ONCONTENT_1,
      type: index$3.LabelTypography.CAPTION_2
    }, "".concat(count, " "), stringSet.CHANNEL__MESSAGE_LIST__NOTIFICATION__NEW_MESSAGE, " ".concat(timeArray.join(' '))), /*#__PURE__*/React__default["default"].createElement(index$3.Icon, {
      width: "24px",
      height: "24px",
      type: index$3.IconTypes.CHEVRON_DOWN,
...
function QuoteMessageThumbnail(_a) {
  ...
  if (index.isThumbnailMessage(message) && thumbnailUrl) {
    return /*#__PURE__*/React__default["default"].createElement(index$3.ImageRenderer, {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$3.IconTypes.FILE_AUDIO,
      fillColor: index$3.IconColors.ON_BACKGROUND_2,
      width: "24px",
      height: "24px"
    }));
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$3.IconTypes.FILE_DOCUMENT,
      fillColor: index$3.IconColors.ON_BACKGROUND_2,
      width: "24px",
      height: "24px"
    }));
...
function QuoteMessageInput(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: index$3.LabelTypography.CAPTION_1,
    color: index$3.LabelColors.ONBACKGROUND_1
  }, stringSet.QUOTE_MESSAGE_INPUT__REPLY_TO + " " + (sender && sender.nickname ? sender.nickname : stringSet.NO_NAME)), /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-quote_message_input__body__message-content",
    type: index$3.LabelTypography.BODY_2,
    color: index$3.LabelColors.ONBACKGROUND_3
  }, index.isImageMessage(fileMessage) && !index.isGifMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE_IMAGE, index.isVideoMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE__VIDEO, index.isGifMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE_GIF, index.isUserMessage(replyingMessage) && replyingMessage.message, index.isFileMessage(fileMessage) && !index.isThumbnailMessage(fileMessage) && fileMessage.name)), /*#__PURE__*/React__default["default"].createElement(index$3.Icon, {
    className: "sendbird-quote_message_input__close-button",
    type: index$3.IconTypes.CLOSE,
    fillColor: index$3.IconColors.ON_BACKGROUND_2,
    width: "24px",
    height: "24px",
    onClick: function onClick() {
...
function ConnectionStatus() {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: index$3.LabelTypography.BODY_2,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, stringSet.TRYING_TO_CONNECT), /*#__PURE__*/React__default["default"].createElement(index$3.Icon, {
    type: index$3.IconTypes.DISCONNECTED,
    fillColor: index$3.IconColors.SENT,
    width: "14px",
    height: "14px"
  }));
}
...
function ChatHeader(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    color: index$3.LabelColors.ONBACKGROUND_1
  }, title || getChannelTitle(currentGroupChannel, userId, stringSet)), /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
    className: "sendbird-chat-header__left__subtitle",
    type: index$3.LabelTypography.BODY_1,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, subTitle)), /*#__PURE__*/React__default["default"].createElement("div", {
    className: "sendbird-chat-header__right"
  }, (typeof isMuted === 'string' && isMuted === 'true' || typeof isMuted === 'boolean' && isMuted) && /*#__PURE__*/React__default["default"].createElement(index$3.Icon, {
    className: "sendbird-chat-header__right__mute",
    type: index$3.IconTypes.NOTIFICATIONS_OFF_FILLED,
    width: "24px",
    height: "24px"
...
exports.UnknownMessageItemBody = UnknownMessageItemBody;
...
//# sourceMappingURL=index-6ef20f15.js.map
