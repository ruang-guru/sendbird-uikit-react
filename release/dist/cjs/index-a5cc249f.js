...
var LocalizationContext = require('./LocalizationContext-e2f1db62.js');
var index = require('./index-c0dfb895.js');
...
var reducer = function reducer(accumulator, currentValue) {
  if (Array.isArray(currentValue)) {
    return LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], accumulator), currentValue);
  } else {
...
var getChannelsWithUpsertedChannel = function getChannelsWithUpsertedChannel(channels, channel) {
  ...
  return LocalizationContext.__spreadArray(LocalizationContext.__spreadArray(LocalizationContext.__spreadArray([], channels.slice(0, targetIndex)), [channel]), channels.slice(targetIndex, channels.length));
};
...
//# sourceMappingURL=index-a5cc249f.js.map
