...
import { j as __assign, _ as __spreadArray, c as _slicedToArray, a as _toConsumableArray, b as _objectSpread2, L as LocalizationContext, w as withSendbirdContext, e as _inherits, f as _createSuper, g as _classCallCheck, d as _defineProperty, h as _assertThisInitialized, i as _createClass } from './LocalizationContext-3c4f0449.js';
import { f as format, aa as Label, ac as LabelTypography, ab as LabelColors, a as Icon, b as IconTypes, a9 as IconColors, a5 as Avatar } from './index-d396e5ca.js';
import 'date-fns';
...
var convertCtaLinkToWebLink = function convertCtaLinkToWebLink(cta, customType) {
  ...
  var url = "https://kelas.ruangguru.com/workspace/" + workspaceSerial + "/classroom/" + classroomSerial + "/" + type_ + "/detail/" + serial;
  return url;
};
...
export { ContextMenu as $, isOGMessage as A, isAssignmentMessage as B, Colors as C, DELETE_MESSAGE as D, EmojiListItems as E, isMaterialMessage as F, getUIKitMessageType as G, getOutgoingMessageState as H, IconButton as I, Button as J, ButtonTypes as K, ButtonSizes as L, MODAL_ROOT as M, isSupportedFileView as N, OutgoingMessageStates as O, isVideo as P, isImage as Q, UserProfileProvider as R, SEND_USER_MESSAGE as S, selectors as T, UPDATE_USER_MESSAGE as U, filterChannelListParams as V, getChannelsWithUpsertedChannel as W, truncateString as X, Modal as Y, Type as Z, TextButton as _, getSendingMessageStatus as a, MenuItems as a0, MenuItem as a1, CREATE_CHANNEL as a2, LEAVE_CHANNEL as a3, getEmojiListAll as a4, getEmojiMapAll as a5, isReactedBy as a6, getEmojiTooltipString as a7, getUIKitFileType as a8, UserProfileContext as a9, ConnectedUserProfile as aa, getSdk as ab, SEND_MESSAGE_START as b, SEND_FILE_MESSAGE as c, getMessageCreatedAt as d, changeColorToClassName as e, filterMessageListParams as f, getOutgoingMessageStates as g, getClassName as h, isSentStatus as i, isUrl as j, isEditedMessage as k, isVideoMessage as l, isGifMessage as m, convertAssignmentDueUTCtoLocale as n, convertCtaLinkToWebLink as o, isUserMessage as p, isFailedMessage as q, isSentMessage as r, isThumbnailMessage as s, copyToClipboard as t, getUIKitMessageTypes as u, isPendingMessage as v, isMessageSentByMe as w, isMessageSentByOperator as x, getSenderName as y, isTextMessage as z };
//# sourceMappingURL=index-9954cdec.js.map
